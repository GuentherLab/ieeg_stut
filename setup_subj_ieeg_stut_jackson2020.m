...
unique_words_file = fullfile(taskpath, sprintf('sub-%s_ses-1_run-1_task-jackson2020_word-list.tsv',subjID));
...
trials_words_save_path = fullfile(taskpath, sprintf('sub-%s_ses-1_run-1_task-jackson2020_trials-words.tsv',subjID));
...
stim_save_path = fullfile(taskpath, sprintf('sub-%s_ses-1_run-1_task-jackson2020_desc-stimulus.txt',subjID));
